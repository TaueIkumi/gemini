...
with open(game_master_path, "rb") as game_master, open(
    player1_path, "rb"
) as player1, open(player2_path, "rb") as player2:
    files = {"gamemaster": game_master, "player1": player1, "player2": player2}
